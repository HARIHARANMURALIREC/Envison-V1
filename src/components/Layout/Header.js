      ...
      <div className="flex items-center justify-between h-16">
        ...
        <div className="flex items-center">
          ...
          <div className="hidden lg:block ml-4">
            <h2 className="text-lg font-semibold text-secondary-900">ENVISION Microscopy Analysis</h2>
            <p className="text-sm text-secondary-500">Advanced Materials Science Platform</p>
          </div>
        </div>
